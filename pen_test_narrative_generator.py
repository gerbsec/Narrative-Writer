...
class PenTestNarrativeGenerator:
                ...
                "osint": [
                    {
                        ...
                        "content": "WKL initiated the assessment by conducting open-source intelligence (OSINT) gathering on {client_company}. This phase involved collecting publicly available information about the organization, including employee details, technology stack, infrastructure, and potential attack vectors. WKL utilized various OSINT techniques including search engine queries, social media analysis, and public database searches to build a comprehensive profile of {client_company}'s digital footprint.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL conducted targeted reconnaissance on {client_company} employees through LinkedIn and other social media platforms. This research identified key personnel, organizational structure, and potential social engineering targets. WKL analyzed employee profiles, job descriptions, and company updates to understand the organization's culture and identify potential attack vectors.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed email address enumeration to identify potential targets for social engineering attacks and credential stuffing. This process involved searching public sources, company websites, and social media platforms for email patterns and employee information. WKL compiled a comprehensive list of email addresses following {client_company}'s naming conventions.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL conducted technology stack identification to understand {client_company}'s infrastructure and potential attack vectors. This process involved analyzing job postings, social media posts, and public documentation to identify technologies, frameworks, and services in use. WKL documented the technology stack to inform subsequent testing phases.",
                        "screenshot": {
                ...
                "dns": [
                    {
                        ...
                        "content": "WKL performed comprehensive DNS enumeration against {client_company}'s infrastructure to identify all associated domains and subdomains. This process involved querying various DNS records including A, AAAA, MX, NS, TXT, and CNAME records. WKL utilized multiple DNS enumeration techniques including zone transfers, reverse DNS lookups, and subdomain brute-forcing to map the complete attack surface.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL searched certificate transparency logs to identify additional subdomains and domains associated with {client_company}. This technique revealed subdomains that may not be publicly advertised but have valid SSL certificates. WKL utilized multiple CT log sources to ensure comprehensive coverage of certificate-issued domains.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL attempted DNS zone transfers against {client_company}'s DNS servers to identify all records within the domain. While zone transfers are typically restricted, WKL tested multiple DNS servers and techniques to identify any misconfigured servers that might allow unauthorized zone transfers.",
                        "screenshot": {
                ...
                "web_app": [
                    {
                        ...
                        "content": "WKL identified and catalogued all web applications within {client_company}'s scope. This process involved port scanning, service enumeration, and web application fingerprinting. WKL documented the technology stack, frameworks, and potential vulnerabilities for each discovered application. The assessment covered both primary websites and discovered subdomain applications.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed thorough SQL injection testing across all web applications and database interfaces. This assessment included union-based, boolean-based, and time-based blind SQL injection techniques. WKL tested various input parameters including forms, URL parameters, and HTTP headers to identify database interaction vulnerabilities.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed directory traversal testing to identify file system access vulnerabilities. This testing involved attempting to access files outside the web root directory using various traversal techniques. WKL tested multiple payloads and encoding methods to bypass input validation and access sensitive system files.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed Cross-Site Request Forgery (CSRF) testing to identify state-changing operations that lack proper CSRF protection. This testing involved creating malicious requests that could be executed by authenticated users without their knowledge. WKL tested various CSRF techniques and payloads to identify vulnerable operations.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL conducted Server-Side Request Forgery (SSRF) testing to identify applications that make requests to external resources based on user input. This testing involved attempting to access internal services, cloud metadata endpoints, and external resources. WKL tested various SSRF techniques to identify potential security issues.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed XML External Entity (XXE) testing to identify applications that process XML input without proper validation. This testing involved attempting to read local files, perform SSRF attacks, and cause denial of service through XML processing. WKL tested various XXE payloads and techniques to identify potential vulnerabilities.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL tested for insecure direct object references by attempting to access resources using predictable identifiers. This testing involved manipulating URLs, form parameters, and API endpoints to access unauthorized resources. WKL tested various enumeration techniques to identify accessible resources and potential data exposure.",
                        "screenshot": {
                ...
                "network": [
                    {
                        ...
                        "content": "WKL conducted comprehensive port scanning against {client_company}'s external infrastructure to identify open ports and running services. This process utilized both TCP and UDP scanning techniques to ensure complete coverage. WKL performed service enumeration on discovered ports to identify software versions and potential vulnerabilities.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed banner grabbing and service fingerprinting on all discovered services to identify software versions and configurations. This process involved connecting to services and analyzing response headers and banners to determine the technology stack and potential vulnerabilities. WKL documented all discovered services and their versions for further analysis.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL conducted comprehensive SSL/TLS configuration analysis on all HTTPS services to identify cryptographic weaknesses and misconfigurations. This testing included cipher suite analysis, certificate validation, and protocol version testing. WKL identified various SSL/TLS issues that could impact the security of encrypted communications.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL tested email servers and configurations to identify potential security issues and information disclosure. This testing included SMTP enumeration, email spoofing tests, and configuration analysis. WKL identified various email-related security issues that could be exploited for social engineering or information gathering.",
                        "screenshot": {
                ...
                "vulnerability_assessment": [
                    {
                        ...
                        "content": "WKL conducted comprehensive Nessus vulnerability scanning against {client_company}'s external infrastructure to identify known security vulnerabilities. This scanning covered network services, web applications, and system configurations. WKL analyzed scan results to identify high-priority vulnerabilities and potential attack vectors for further exploitation.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL utilized Burp Suite Professional to perform automated web application vulnerability scanning against {client_company}'s web applications. This scanning identified various web application vulnerabilities including injection flaws, authentication bypasses, and configuration issues. WKL analyzed scan results and performed manual verification of identified issues.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed manual verification and exploitation of all identified vulnerabilities to confirm their existence and assess their actual impact. This process involved reproducing vulnerabilities, testing exploitability, and determining the business impact. WKL provided detailed proof-of-concept demonstrations for all confirmed vulnerabilities.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed CVE enumeration and exploit testing against all discovered services and applications within {client_company}'s scope. This process involved identifying known vulnerabilities for discovered software versions and testing available exploits. WKL documented all exploitable CVEs and their potential impact on the organization's security posture.",
                        "screenshot": {
                ...
                "credential_testing": [
                    {
                        ...
                        "content": "WKL conducted default credential testing against all discovered services and applications within {client_company}'s infrastructure. This testing involved attempting to authenticate using common default usernames and passwords for various services including web applications, network devices, and management interfaces. WKL documented any successful default credential authentications.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed leaked credential testing by searching for {client_company} credentials in known data breach databases and paste sites. This testing involved checking employee email addresses and usernames against compromised credential databases. WKL tested any discovered credentials against {client_company}'s systems to identify potential account compromises.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL conducted two-factor authentication (2FA) bypass testing to identify weaknesses in multi-factor authentication implementations. This testing included session fixation attacks, response manipulation, and social engineering techniques. WKL tested various 2FA bypass methods to determine the effectiveness of multi-factor authentication controls.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL tested password policies and performed controlled brute force attacks against {client_company}'s authentication systems. This testing involved analyzing password complexity requirements, account lockout policies, and rate limiting mechanisms. WKL documented any weak password policies or successful brute force attacks.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed comprehensive checking to determine if two-factor authentication (2FA) is enabled on {client_company}'s services and applications. This testing involved attempting to authenticate to various services and analyzing login flows to identify which systems have 2FA protection enabled. WKL documented the 2FA implementation status across all discovered services.",
                        "screenshot": {
            ...
            "internal": {
                "network_discovery": [
                    {
                        ...
                        "content": "WKL initiated the internal assessment by performing comprehensive network discovery to map {client_company}'s internal infrastructure. This process involved identifying active hosts, network segments, and network topology. WKL utilized various discovery techniques including ARP scanning, ping sweeps, and network service enumeration to build a complete picture of the internal environment.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL analyzed network segmentation to identify VLANs, subnets, and network boundaries within {client_company}'s infrastructure. This analysis involved mapping network topology, identifying routing configurations, and testing for potential segmentation bypasses. WKL documented the network architecture and identified potential security issues.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed comprehensive Active Directory enumeration to identify domain structure, users, groups, and policies within {client_company}'s environment. This process involved querying domain controllers, enumerating user accounts, and analyzing group memberships. WKL identified potential attack vectors and privilege escalation opportunities.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL utilized BloodHound to perform comprehensive Active Directory analysis and identify attack paths within {client_company}'s environment. This testing involved collecting Active Directory data, analyzing relationships between users and systems, and identifying potential privilege escalation paths. WKL documented discovered attack paths and high-value targets.",
                        "screenshot": {
                ...
                "privilege_escalation": [
                    {
                        ...
                        "content": "WKL conducted local privilege escalation testing on compromised systems within {client_company}'s environment. This assessment involved identifying misconfigurations, weak permissions, and vulnerable services that could be exploited to gain elevated privileges. WKL tested various escalation vectors including kernel exploits, service misconfigurations, and credential harvesting techniques.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed Windows-specific privilege escalation testing to identify misconfigurations and vulnerabilities that could lead to elevated privileges. This testing included service enumeration, registry analysis, and kernel exploit testing. WKL identified various Windows-specific security issues and potential escalation paths.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL conducted Linux-specific privilege escalation testing to identify system misconfigurations and vulnerabilities. This testing included SUID/SGID analysis, cron job enumeration, and kernel exploit testing. WKL identified various Linux-specific security issues and potential escalation vectors.",
                        "screenshot": {
                ...
                "lateral_movement": [
                    {
                        ...
                        "content": "WKL performed lateral movement testing to demonstrate how an attacker could traverse {client_company}'s network after initial compromise. This process involved credential harvesting, pass-the-hash attacks, and network service exploitation. WKL demonstrated the potential for attackers to move between systems and escalate their access across the network.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL conducted pass-the-hash attacks to demonstrate how compromised credentials could be used to access additional systems within {client_company}'s network. This testing involved using harvested password hashes to authenticate to remote systems without cracking the actual passwords. WKL demonstrated the effectiveness of this attack technique across the network.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed Kerberoasting attacks to extract and crack service account password hashes within {client_company}'s Active Directory environment. This testing involved requesting service tickets for service accounts and extracting password hashes for offline cracking. WKL documented successful Kerberoasting attacks and cracked service account passwords.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed ASREPRoasting attacks to extract and crack user account password hashes within {client_company}'s Active Directory environment. This testing involved identifying users with Kerberos pre-authentication disabled and requesting AS-REP responses for offline cracking. WKL documented successful ASREPRoasting attacks and cracked user passwords.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL conducted SMB and RPC enumeration to identify file shares, user accounts, and system information within {client_company}'s network. This testing involved querying SMB shares, enumerating user accounts, and identifying potential attack vectors. WKL documented discovered shares and user information for further exploitation.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed SMB signing checks to determine if SMB message signing is enabled on discovered systems within {client_company}'s network. This testing involved using tools like nmap and smbclient to check SMB signing requirements. WKL documented systems with SMB signing disabled, which could be vulnerable to NTLM relay attacks.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL conducted mitm6 attacks to exploit IPv6 DNS takeover vulnerabilities within {client_company}'s network. This testing involved setting up rogue IPv6 DNS servers to capture authentication attempts and NTLM hashes. WKL documented successful credential captures and potential lateral movement opportunities.",
                        "screenshot": {
                ...
                "persistence": [
                    {
                        ...
                        "content": "WKL tested various persistence mechanisms to demonstrate how attackers could maintain access to {client_company}'s systems after initial compromise. This testing included scheduled tasks, service installation, registry modifications, and startup programs. WKL identified potential persistence vectors and demonstrated their effectiveness.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL tested backdoor installation techniques to demonstrate how attackers could maintain persistent access to {client_company}'s systems. This testing included web shells, reverse shells, and custom backdoors. WKL demonstrated various backdoor techniques and their detection evasion capabilities.",
                        "screenshot": {
                ...
                "data_exfiltration": [
                    {
                        ...
                        "content": "WKL conducted data exfiltration testing to demonstrate how attackers could steal sensitive information from {client_company}'s systems. This testing included file transfer techniques, data encoding, and network tunneling. WKL demonstrated various exfiltration methods and their detection evasion capabilities.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL searched for sensitive data including passwords, certificates, and confidential documents on compromised systems within {client_company}'s environment. This testing involved file system searches, registry analysis, and memory dumps. WKL identified various types of sensitive information that could be valuable to attackers.",
                        "screenshot": {
                ...
                "credential_harvesting": [
                    {
                        ...
                        "content": "WKL performed credential harvesting and dumping on compromised systems within {client_company}'s environment. This testing involved extracting password hashes, plaintext credentials, and authentication tokens from memory, registry, and file systems. WKL utilized various credential harvesting techniques to demonstrate the potential for credential theft.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL utilized impacket tools to perform credential dumping from domain controllers and other systems within {client_company}'s environment. This testing involved using secretsdump.py to extract password hashes, cached credentials, and domain secrets from compromised systems. WKL documented all extracted credentials for further exploitation.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL utilized CrackMapExec (nxc) to perform credential dumping and lateral movement testing within {client_company}'s environment. This testing involved using nxc to dump credentials, execute commands, and perform various attack techniques across the network. WKL documented successful credential dumps and lateral movement opportunities.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL searched PowerShell history files and command logs for credentials and sensitive information within {client_company}'s environment. This testing involved examining PowerShell execution history, command logs, and script files to identify stored credentials, API keys, and other sensitive data. WKL documented discovered credentials and sensitive information.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL tested credential capture techniques including keyloggers and network sniffing to demonstrate how attackers could intercept user credentials within {client_company}'s environment. This testing involved deploying keylogging software and capturing network traffic to identify authentication credentials in transit.",
                        "screenshot": {
                ...
                "defense_evasion": [
                    ...
                    },
                    {
                        ...
                        "content": "WKL tested log clearing and artifact removal techniques to demonstrate how attackers could cover their tracks within {client_company}'s environment. This testing included clearing event logs, deleting files, and modifying system artifacts to avoid forensic detection.",
                        "screenshot": {
                ...
                "adcs_vulnerabilities": [
                    ...
                    },
                    {
                        ...
                        "content": "WKL tested for ESC1 vulnerabilities involving misconfigured certificate templates that allow domain users to request certificates with domain admin privileges within {client_company}'s ADCS environment. This testing involved identifying vulnerable certificate templates and demonstrating privilege escalation through certificate enrollment.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL tested for ESC4 vulnerabilities involving certificate templates with vulnerable Access Control Lists (ACLs) that allow unauthorized certificate enrollment within {client_company}'s ADCS environment. This testing involved identifying vulnerable certificate templates and demonstrating unauthorized certificate enrollment.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL tested for ESC6 vulnerabilities involving the EDITF_ATTRIBUTESUBJECTALTNAME2 flag being enabled on the Certificate Authority within {client_company}'s ADCS environment. This testing involved identifying the vulnerable configuration and demonstrating privilege escalation through certificate enrollment.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL tested for ESC8 vulnerabilities involving NTLM relay attacks to ADCS HTTP endpoints within {client_company}'s environment. This testing involved identifying ADCS HTTP endpoints and demonstrating privilege escalation through NTLM relay attacks.",
                        "screenshot": {
                ...
                "internal_vulnerability_assessment": [
                    {
                        ...
                        "content": "WKL conducted comprehensive Nessus vulnerability scanning against {client_company}'s internal infrastructure to identify known security vulnerabilities. This scanning covered internal network services, systems, and configurations. WKL analyzed scan results to identify high-priority vulnerabilities and potential attack vectors for further exploitation.",
                        "screenshot": {
                    ...
                    },
                    {
                        ...
                        "content": "WKL performed CVE enumeration and exploit testing against all internal systems and services within {client_company}'s environment. This process involved identifying known vulnerabilities for discovered software versions and testing available exploits. WKL documented all exploitable CVEs and their potential impact on the organization's internal security posture.",
                        "screenshot": {
    ...
    def get_user_input(self):
        ...
        # Get testing company
        self.testing_company = input("What company is performing the test? (e.g., WKL): ").strip()
        if not self.testing_company:
            self.testing_company = "WKL"
